...
Item {
  ...
  readonly property string currentIpv6: ipMonitorService?.currentIpv6 ?? "n/a"
  ...
  function copyToClipboard(value, label) {
    if (value && value !== "n/a") {
      Quickshell.execDetached(["sh", "-c", `printf '%s' '${value}' | wl-copy`]);
      ToastService.showNotice(label + " copied to clipboard: " + value);
      Logger.d("IpMonitor", "Copied", label, "to clipboard:", value);
    } else {
      ToastService.showNotice("Nothing to copy");
    }
  }
            ...
            Repeater {
              ...
              RowLayout {
                ...
                NText {
                  ...
                  font.family: Settings.data.ui.fontFixed
                  color: Color.mOnSurface
                  Layout.fillWidth: modelData.copyable !== true
                  elide: Text.ElideRight
                }

                NIcon {
                  id: copyIcon
                  visible: modelData.copyable === true && root.fetchState === "success"
                  icon: "copy"
                  ...
                  MouseArea {
                    ...
                    onClicked: {
                      root.copyToClipboard(modelData.value, modelData.label);
                    }
                  }
                }
              }
